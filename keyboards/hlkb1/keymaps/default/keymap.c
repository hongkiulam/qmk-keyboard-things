...
LAYOUT(
  ...
  KC_CAPS, KC_A, KC_S, KC_D, KC_F, KC_G, TD(TD_H_LEFT), TD(TD_J_DOWN), TD(TD_K_UP), TD(TD_L_RIGHT), KC_ENT, 
...
LAYOUT(
    ...
    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, ARROWFUNC, KC_TRNS, 
