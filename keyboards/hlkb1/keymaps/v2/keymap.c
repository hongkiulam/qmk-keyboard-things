...
LAYOUT(
  ...
  KC_LCTL, KC_LGUI, KC_LALT, MO(2), KC_SPC, MO(1), KC_LEFT, KC_DOWN, KC_UP, KC_RGHT),

LAYOUT(
  KC_CAPS, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_TRNS, KC_TRNS, KC_EQL, KC_LBRC, KC_RBRC, KC_BSLS, KC_TRNS, 
  KC_TRNS, KC_DLR, KC_PERC, KC_CIRC, KC_TRNS, KC_TRNS, KC_GRV, KC_MINS, KC_SCLN, KC_QUOT, KC_TRNS, 
  KC_TRNS, KC_EXLM, KC_AT, KC_HASH, KC_TRNS, KC_TRNS, KC_TRNS, KC_LPRN, KC_RPRN, KC_SLSH, KC_TRNS, 
  KC_TRNS, KC_TRNS, KC_TRNS, MO(3), KC_TRNS, KC_TRNS, KC_TRNS, KC_VOLD, KC_VOLU, KC_TRNS),

LAYOUT(
  KC_TAB, KC_7, KC_8, KC_9, KC_0, KC_TRNS, KC_TRNS, KC_PLUS, KC_LCBR, KC_RCBR, KC_PIPE, KC_TRNS, 
